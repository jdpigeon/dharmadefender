...
(function(){
  ...
  GameLaunchUI.prototype.onGameChoiceMade = function(deviceType){
    ...
    document.querySelector("#eegConnectCard").classList.remove("hide");
    document.querySelector("#roomJoinIncentive").innerHTML += location.href;
    document.querySelector('#eegConnectGo').addEventListener("click", this.onEEGConnectGo);
  ...
  GameLaunchUI.prototype.onEEGConnectGo = function(){
    console.log('onEEGConnect');
    document.querySelector("#eegConnectCard").classList.add("hide");
